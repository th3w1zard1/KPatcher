...
namespace Andastra.Runtime.Kotor.Data
{
    /// <summary>
    ...
    public class GameDataManager
    {
        ...
        public TwoDA GetTable(string tableName)
        {
            ...
            try
            {
                ResourceResult resource = _installation.Resources.LookupResource(tableName, Andastra.Parsing.Resources.ResourceType.TwoDA);
