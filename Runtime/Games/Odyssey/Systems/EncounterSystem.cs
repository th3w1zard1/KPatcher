...
using Andastra.Runtime.Kotor.Components;
using Andastra.Runtime.Kotor.Combat;

namespace Andastra.Runtime.Kotor.Systems
{
    /// <summary>
    ...
    public class EncounterSystem
    {
        ...
        private readonly Func<Andastra.Parsing.Module> _getCurrentModule;
        ...
        public EncounterSystem(IWorld world, FactionManager factionManager, Action<IEntity, ScriptEvent, IEntity> scriptExecutor, Loading.ModuleLoader moduleLoader, Func<IEntity, bool> isPlayerCheck = null, Func<Andastra.Parsing.Module> getCurrentModule = null)
        ...
        private void SpawnEncounterCreatures(IEntity encounter, EncounterComponent encounterComp, int count)
        {
            ...
            for (int i = 0; i < count && spawned < encounterComp.MaxCreatures; i++)
            {
                ...
                {
                    Andastra.Parsing.Module csharpModule = _getCurrentModule();
