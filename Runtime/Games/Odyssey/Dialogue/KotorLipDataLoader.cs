...
using ResourceIdentifier = Andastra.Parsing.Resources.ResourceIdentifier;
using ResourceType = Andastra.Parsing.Resources.ResourceType;
    ...
    public class KotorLipDataLoader : ILipDataLoader
    {
        ...
        public LipSyncData LoadLipData(string resRef)
        {
            ...
            try
            {
                ...
                // Convert CSharpKOTOR LIP to Andastra.Runtime.Core LipSyncData
