...
namespace Andastra.Runtime.Kotor.Dialogue
{
    /// <summary>
    /// Dialogue loader implementation using CSharpKOTOR DLG format.
    /// Converts Andastra.Formats.Resource.Generics.DLG.DLG to Andastra.Runtime.Core.Dialogue.RuntimeDialogue.
    /// </summary>
    /// <remarks>
    /// Dialogue Loader:
        ...
        public RuntimeDialogue LoadDialogue(string resRef)
        {
            ...
            try
            {
                byte[] data = _resourceProvider.GetResourceBytesAsync(
                    new Andastra.Formats.Resources.ResourceIdentifier(resRef, Andastra.Formats.Resources.ResourceType.DLG),
                ...
                DLG dlg = Andastra.Formats.Resource.Generics.DLG.DLGHelper.ReadDlg(data);
