...
using Andastra.Runtime.Kotor.Profiles;
using Andastra.Runtime.Scripting.EngineApi;
using Andastra.Runtime.Scripting.Interfaces;

namespace Andastra.Runtime.Kotor.Profiles
{
    /// <summary>
    ...
    public class K2GameProfile : IGameProfile
    {
        ...
        public Andastra.Runtime.Content.Interfaces.GameType GameType
        {
            get { return Andastra.Runtime.Content.Interfaces.GameType.K2; }
        }
