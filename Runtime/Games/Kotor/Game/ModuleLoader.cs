...
using MDLData = Andastra.Formats.Formats.MDLData;
...
using InstResourceResult = Andastra.Formats.Installation.ResourceResult;
...
namespace Andastra.Runtime.Kotor.Game
{
    ...
    public class ModuleLoader
    {
        ...
        /// </summary>
        [CanBeNull]
        public Andastra.Formats.Module GetCSharpKotorModule()
        {
            ...
            try
            {
                ...
                return new Andastra.Formats.Module(_currentModuleRoot, _installation);
            }
            catch (Exception ex)
            {
