...
namespace Andastra.Formats.Formats.GFF
{
    ...
    public class GFFBinaryWriter
    {
        ...
        private readonly Andastra.Formats.RawBinaryWriter _structWriter;
        private readonly Andastra.Formats.RawBinaryWriter _fieldWriter;
        private readonly Andastra.Formats.RawBinaryWriter _fieldDataWriter;
        private readonly Andastra.Formats.RawBinaryWriter _fieldIndicesWriter;
        private readonly Andastra.Formats.RawBinaryWriter _listIndicesWriter;
        ...
        {
            _gff = gff;
            _structWriter = Andastra.Formats.RawBinaryWriter.ToByteArray();
            _fieldWriter = Andastra.Formats.RawBinaryWriter.ToByteArray();
            _fieldDataWriter = Andastra.Formats.RawBinaryWriter.ToByteArray();
            _fieldIndicesWriter = Andastra.Formats.RawBinaryWriter.ToByteArray();
            _listIndicesWriter = Andastra.Formats.RawBinaryWriter.ToByteArray();
        }
        ...
        public byte[] Write()
        {
            ...
            using (var fileWriter = Andastra.Formats.RawBinaryWriter.ToByteArray())
            {
                // Write header
