...
namespace Andastra.Formats.Formats.NCS.NCSDecomp.Lexer
{
    public class Lexer
    {
        ...
        public Lexer(PushbackReader @in)
        {
            ...
            if (Lexer.gotoTable == null)
            {
                try
                {
                    System.IO.Stream stream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("Andastra.Formats.Formats.NCS.NCSDecomp.lexer.dat") ?? System.Reflection.Assembly.GetCallingAssembly().GetManifestResourceStream("Andastra.Formats.Formats.NCS.NCSDecomp.lexer.dat");
                    if (stream == null)
                    {
