...
namespace Andastra.Formats.Tools
{
    ...
    public class PazaakSideCard
    {
        ...
        {
            if (CardType == Andastra.Formats.Tools.CardType.YellowSpecial)
            {
                return $"Yellow {Value}";
            }
            string valueStr = Value.ToString();
            if (CardType == Andastra.Formats.Tools.CardType.Positive)
            {
                return $"+{valueStr}";
            }
            if (CardType == Andastra.Formats.Tools.CardType.Negative)
            {
                return $"-{valueStr}";
            }
            if (CardType == Andastra.Formats.Tools.CardType.PosOrNeg)
            {
                return $"+/-{valueStr}";
            }
            return valueStr;
