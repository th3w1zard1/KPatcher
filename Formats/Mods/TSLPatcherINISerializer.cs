...
using TargetType = Andastra.Formats.Mods.TwoDA.TargetType;
...
namespace Andastra.Formats.Mods
{
    ...
    public class TSLPatcherINISerializer
    {
        ...
        private string SerializeTokenUsage(object tokenUsage)
        {
            ...
            if (tokenUsage is Andastra.Formats.Memory.TokenUsageTLK tlkUsage)
            {
                return $"StrRef{tlkUsage.TokenId}";
            }
            if (tokenUsage is Andastra.Formats.Memory.TokenUsage2DA twodaUsage)
            {
                return $"2DAMEMORY{twodaUsage.TokenId}";
            }
            if (tokenUsage is Andastra.Formats.Memory.NoTokenUsage noToken)
            {
