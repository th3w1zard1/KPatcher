...
namespace Andastra.Formats
{
    ...
    public class Module
    {
        ...
        public Module(string filenameOrRoot, Installation.Installation installation, bool useDotMod = true)
        {
            ...
            string modulesPath = Andastra.Formats.Installation.Installation.GetModulesPath(_installation.Path);
            if (_dotMod)
            {
        ...
        private void ProcessModelTextures(string displayName)
        {
            ...
            foreach (ModuleResource model in Models())
            {
                ...
                try
                {
                    ...
                    lookupTextureQueries.UnionWith(Andastra.Formats.Tools.ModelTools.IterateTextures(modelData));
                    lookupLightmapQueries.UnionWith(Andastra.Formats.Tools.ModelTools.IterateLightmaps(modelData));
                }
                catch (Exception ex)
                {
