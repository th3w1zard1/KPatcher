...
from pykotor.common.script import (  # type: ignore[import-not-found, note]  # pyright: ignore[reportMissingImports]
    DataType,  # type: ignore[import-not-found, note]  # pyright: ignore[reportMissingImports]
    ScriptConstant,
    ScriptFunction,
    ScriptParam,
)
...
def convert_value(value: Any, dt: DataType) -> str:
    ...
    if dt == DataType.INT:
        ...
        from utility.common.geometry import (
            Vector3,  # type: ignore[import-not-found, note]  # pyright: ignore[reportMissingImports]
        )
