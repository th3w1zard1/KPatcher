...
KPatcher uses [NetSparkle](https://github.com/netsparkleupdater/netsparkle) for industry-standard automatic updates. This document explains how to set up and configure the auto-update system.
...
<rss version="2.0" xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle">
  <channel>
    ...
    <item>
      ...
      <enclosure 
        url="https://github.com/user/repo/releases/download/v2.0.0/KPatcher-2.0.0-win-x64.zip"
