# MonoGame Packaging Guide

This document describes industry-standard practices for packaging and distributing MonoGame projects, and how to use the provided packaging scripts.
...
According to MonoGame best practices, the following files should be removed from release builds:
...
Industry-standard MonoGame game distribution structure:
