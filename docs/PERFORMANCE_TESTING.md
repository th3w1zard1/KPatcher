...
.\scripts\RunAllTestsWithProfiling.ps1 -Projects @("tests\KPatcher.Tests\KPatcher.Tests.csproj")
...
```powershell
dotnet test tests/KPatcher.Tests/KPatcher.Tests.csproj --logger "console;verbosity=detailed"
```
