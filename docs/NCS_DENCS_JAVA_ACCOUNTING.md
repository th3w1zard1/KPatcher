...
| Full solution tests pass | **Met** | Wrapper command below; **789/789** `KPatcher.Tests` (Default.runsettings) on Linux at `1f7b9c1f` (2026-06-10). |
