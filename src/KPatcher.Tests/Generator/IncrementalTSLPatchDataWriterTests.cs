...
using TLKAuto = global::KPatcher.Core.Formats.TLK.TLKAuto;
using TwoDAAuto = global::KPatcher.Core.Formats.TwoDA.TwoDAAuto;
using GFFAuto = global::KPatcher.Core.Formats.GFF.GFFAuto;
using SSFAuto = global::KPatcher.Core.Formats.SSF.SSFAuto;
...
using KPatcher.Core.KPatcher;
using FluentAssertions;
using Xunit;

namespace KPatcher.Core.Tests.Generator
{
    /// <summary>
    /// Comprehensive tests for IncrementalTSLPatchDataWriter.
    /// Tests incremental writing of KPatcher data files and INI sections.
    /// </summary>
