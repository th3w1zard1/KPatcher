...
namespace KPatcher.Core.Tests.Integration
{
    ...
    /// <summary>
    /// Integration tests for KPatcher functionality
    /// Ported from tests/kpatcher/test_kpatcher.py
    /// </summary>
    public class KPatcherTests
    {
        private static PatcherConfig SetupIniAndConfig(string iniText, string modPath = "")
        {
            ...
            // KPatcher uses case-insensitive matching for sections/keys generally,
