...
namespace BioWareEngines.Engines.Odyssey.EngineApi
{
    /// <summary>
    /// Odyssey Engine KOTOR 2 (TSL) engine API implementation.
    ...
    /// </remarks>
    public class OdysseyK2EngineApi : BaseEngineApi
    {
        private readonly NcsVm _vm;

        public OdysseyK2EngineApi()
        {
            _vm = new NcsVm();
        }
        ...
        private Variable Func_ExecuteScript(IReadOnlyList<Variable> args, IExecutionContext ctx)
        {
            ...
            {
                Console.WriteLine("[OdysseyK2EngineApi] ExecuteScript error: " + ex.Message);
            }
