    ...
    public class IFOEditorTests : IClassFixture<AvaloniaTestFixture>
    {
        ...
        public void TestIfoEditorManipulateVoId()
        {
            ...
            foreach (var voId in testVoIds)
            {
                ...
                var modifiedIfo = AuroraEngine.Common.Resource.Generics.IFOHelpers.ConstructIfo(modifiedGff);
        ...
        public void TestIfoEditorLoadExistingFile()
        {
            ...
            AuroraEngine.Common.Resource.Generics.IFO originalIfo = AuroraEngine.Common.Resource.Generics.IFOHelpers.ConstructIfo(originalGff);
            ...
            var loadedIfo = AuroraEngine.Common.Resource.Generics.IFOHelpers.ConstructIfo(newGff);
        ...
        public void TestIfoEditorManipulateAllScripts()
        {
            ...
            var ifoType = typeof(AuroraEngine.Common.Resource.Generics.IFO);
            foreach (var scriptName in editor.ScriptFields.Keys)
            {
        ...
        public void TestIfoEditorSaveLoadRoundtripIdentity()
        {
            ...
            var savedIfo1 = AuroraEngine.Common.Resource.Generics.IFOHelpers.ConstructIfo(GFF.FromBytes(data1));
            ...
            var savedIfo2 = AuroraEngine.Common.Resource.Generics.IFOHelpers.ConstructIfo(GFF.FromBytes(data2));
        ...
        public void TestIfoEditorMultipleSaveLoadCycles()
        {
            ...
            for (int cycle = 0; cycle < 5; cycle++)
            {
                ...
                // Save
                var (data, _) = editor.Build();
                var savedIfo = AuroraEngine.Common.Resource.Generics.IFOHelpers.ConstructIfo(GFF.FromBytes(data));
