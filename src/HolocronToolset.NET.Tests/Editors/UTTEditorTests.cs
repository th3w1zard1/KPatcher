...
namespace HolocronToolset.NET.Tests.Editors
{
    ...
    public class UTTEditorTests : IClassFixture<AvaloniaTestFixture>
    {
        ...
        public void TestUttEditorManipulateNameLocstring()
        {
            ...
            var originalUtt = AuroraEngine.Common.Resource.Generics.UTTAuto.ReadUtt(originalData);
        ...
        public void TestUttEditorManipulateAutoRemoveKeyCheckbox()
        {
            ...
            var modifiedUtt1 = AuroraEngine.Common.Resource.Generics.UTTAuto.ReadUtt(data1);
            ...
            var modifiedUtt2 = AuroraEngine.Common.Resource.Generics.UTTAuto.ReadUtt(data2);
        ...
        public void TestUttEditorSaveLoadRoundtripWithModifications()
        {
            ...
            // Save
            var (data1, _) = editor.Build();
            var savedUtt1 = AuroraEngine.Common.Resource.Generics.UTTAuto.ReadUtt(data1);
        ...
        public void TestUttEditorMultipleSaveLoadCycles()
        {
            ...
            for (int cycle = 0; cycle < 5; cycle++)
            {
                ...
                // Save
                var (data, _) = editor.Build();
                var savedUtt = AuroraEngine.Common.Resource.Generics.UTTAuto.ReadUtt(data);
