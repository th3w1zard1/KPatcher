    ...
    public class ScriptExecutor
    {
        ...
        public void Update(float deltaTime)
        {
            ...
            if (_heartbeatTimer >= HeartbeatInterval)
            {
                ...
                foreach (IEntity entity in _world.GetEntitiesInRadius(System.Numerics.Vector3.Zero, float.MaxValue, Odyssey.Core.Enums.ObjectType.All))
                {
        ...
        public void ExecuteScript(IEntity caller, string scriptResRef, IEntity triggerer = null)
        {
            ...
            try
            {
                ...
                var ctx = new Odyssey.Scripting.VM.ExecutionContext(caller, _world, _engineApi, _globals);
