...
namespace Odyssey.Engines.Odyssey.Profiles
{
    ...
    /// </remarks>
    public class OdysseyK1GameProfile : BaseEngineProfile
    {
        ...
        private class K1ResourceConfig : IEngineProfile.IResourceConfig
        {
        ...
        private class K1TableConfig : IEngineProfile.ITableConfig
        {
