...
{
    // Moved from AuroraEngine.Common.Resource.Generics.UTP to Odyssey.Engines.Odyssey.Templates
    ...
    /// </summary>
    /// <remarks>
    /// UTP (Placeable Template) Format:
    /// - Based on swkotor2.exe placeable template system
    ...
    /// - Original implementation: UTP files are GFF with "UTP " signature containing placeable template data
    /// - GFF fields: TemplateResRef, Tag, LocName, Conversation, Faction, Appearance, AnimationState, etc.
    ...
    /// - Inventory: ItemList contains inventory items
    /// - Script hooks: OnClick, OnClosed, OnDamaged, OnDeath, OnEndDialogue, OnFailToOpen, OnHeartbeat, OnInvDisturbed, OnMeleeAttacked, OnOpen, OnUnlock, OnUsed, OnLock, OnSpellCastAt
    /// - Matching PyKotor implementation at Libraries/PyKotor/src/pykotor/resource/generics/utp.py:17
    /// </remarks>
    [PublicAPI]
