...
{
    // Moved from AuroraEngine.Common.Resource.Generics.UTIHelpers to Odyssey.Engines.Odyssey.Templates
    ...
    /// <remarks>
    /// UTI Helper Functions:
    /// - Based on swkotor2.exe item template loading/saving system
    ...
    /// - ConstructUti: Parses GFF structure into UTI object, extracts all fields (properties, costs, charges, upgrades)
    /// - DismantleUti: Converts UTI object back to GFF structure, writes all fields in correct format
    /// - GFF field names match original engine exactly (TemplateResRef, BaseItem, LocalizedName, DescIdentified, Description, etc.)
    /// - Properties: PropertiesList contains item properties with PropertyName, Subtype, CostTable, CostValue, Param1, Param1Value, ChanceAppear, UpgradeType
    /// - Upgrades: UpgradeLevel (K2 only) for item enhancement system
    /// - Matching PyKotor implementation at Libraries/PyKotor/src/pykotor/resource/generics/uti.py:203-407
    /// </remarks>
