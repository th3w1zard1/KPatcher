...
{
    // Moved from AuroraEngine.Common.Resource.Generics.UTT to Odyssey.Engines.Odyssey.Templates
    ...
    /// </summary>
    /// <remarks>
    /// UTT (Trigger Template) Format:
    /// - Based on swkotor2.exe trigger template system
    ...
    /// - Original implementation: UTT files are GFF with "UTT " signature containing trigger template data
    /// - GFF fields: TemplateResRef, Tag, AutoRemoveKey, Faction, Cursor, HighlightHeight, KeyName, Type, etc.
