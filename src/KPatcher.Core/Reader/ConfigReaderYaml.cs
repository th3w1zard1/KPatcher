...
{
    /// <summary>
    /// YAML equivalent of INI for changes.ini-style config.
    /// Each section is a list of key-value pairs to preserve duplicate keys and order.
    /// </summary>
    ...
    /// <summary>
    /// Converts between IniData (ini-parser) and YAML for ConfigReader.
    /// Used to generate .yaml when loading .ini and to load .yaml as config.
    /// </summary>
    public static class ConfigReaderYaml
    {
        ...
        /// <summary>
        /// Loads and parses a YAML file into IniData (same structure as INI for ConfigReader).
        /// </summary>
