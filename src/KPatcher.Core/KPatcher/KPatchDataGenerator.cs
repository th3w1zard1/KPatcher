// Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:68-129
...
using GFFContent = KPatcher.Core.Formats.GFF.GFFContent;
using TLKAuto = KPatcher.Core.Formats.TLK.TLKAuto;
using TwoDAAuto = KPatcher.Core.Formats.TwoDA.TwoDAAuto;
using GFFAuto = KPatcher.Core.Formats.GFF.GFFAuto;
using SSFAuto = KPatcher.Core.Formats.SSF.SSFAuto;
using LIPAuto = KPatcher.Core.Formats.LIP.LIPAuto;
...
namespace KPatcher.Core.KPatcher
{
    ...
    public class TSLPatchDataGenerator
    {
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:71-79
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:81-129
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:289-338
            ...
            DirectoryInfo baseDataPath)
        {
            ...
            {
                // All modifiers should be appends (no replacements per KPatcher design)
                ...
                {
                    Console.WriteLine($"[WARNING] Found {replacements.Count} replacement modifiers in TLK - KPatcher only supports appends!");
                }
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:340-391
            ...
            DirectoryInfo baseDataPath)
        {
            ...
            foreach (var mod2da in twodaModifications)
            {
                ...
                if (baseDataPath != null)
                {
                    ...
                    if (!found)
                    {
                        Console.WriteLine($"[WARNING] Could not find base 2DA file for {filename} - KPatcher may fail without it");
                    }
                }
            }
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:393-450
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:452-488
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:911-972
            ...
            DirectoryInfo baseDataPath)
        {
            ...
            foreach (var modSsf in ssfModifications)
            {
                ...
                if (replaceFile)
                {
                    ...
                    {
                        if (modifier is global::KPatcher.Core.Mods.SSF.ModifySSF modifySsf)
                        {
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:131-231
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:233-287
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:490-508
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:509-551
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:553-574
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:576-600
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:602-644
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:646-673
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:675-699
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:849-891
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:893-909
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:701-750
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:752-789
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:791-811
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:813-848
