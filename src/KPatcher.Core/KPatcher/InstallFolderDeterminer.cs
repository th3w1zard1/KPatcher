// Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:1212-1236
...
namespace KPatcher.Core.KPatcher
{
    ...
    public static class InstallFolderDeterminer
    {
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:1107-1122
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:1125-1149
        ...
        private static void ProcessTlkModifications(List<ModificationsTLK> modifications, Dictionary<string, List<string>> installFolders)
        {
            ...
            foreach (var modTlk in modifications)
            {
                ...
                // Only check for appends (KPatcher doesn't support replacements)
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:1152-1164
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:1166-1180
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:1182-1194
        ...
        // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/kpatcher/diff/generator.py:1196-1210
