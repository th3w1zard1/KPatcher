...
namespace KPatcher.Core.Mods
{
    ...
    /// <summary>
    /// Abstract base class for KPatcher modifications.
    /// 
    /// Args:
    /// ----
    ...
    ///         KPatcher's InstallList and CompileList are the only patchlists that handle replace behavior differently.
    ...
    ///     pop_kpatcher_vars(file_section_dict, default_destination): Parse optional KPatcher exclamation point variables.
    /// 
    ...
    public abstract class PatcherModifications
    {
        ...
        /// <summary>
        /// All optional KPatcher vars that can be parsed for a given patch list.
        /// </summary>
