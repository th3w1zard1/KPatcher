...
namespace KPatcher.Core.Tools
{
    ...
    public class PazaakSideCard
    {
        ...
        {
            if (CardType == global::KPatcher.Core.Tools.CardType.YellowSpecial)
            {
                return $"Yellow {Value}";
            }
            string valueStr = Value.ToString();
            if (CardType == global::KPatcher.Core.Tools.CardType.Positive)
            {
                return $"+{valueStr}";
            }
            if (CardType == global::KPatcher.Core.Tools.CardType.Negative)
            {
                return $"-{valueStr}";
            }
            if (CardType == global::KPatcher.Core.Tools.CardType.PosOrNeg)
            {
                return $"+/-{valueStr}";
            }
            return valueStr;
