...
//
// Port of DeNCS DestroyParseTree.java.
...
{
    /// <summary>
    /// Clears parse-tree child references after codegen to help GC (DeNCS DestroyParseTree).
    /// </summary>
    public sealed class DestroyParseTree : AnalysisAdapter
    {
        ...
        public override void CaseAProgram(AProgram node)
        {
            ...
            node.SetReturn(null);
            node.SetSubroutine(new PSubroutine[0]);
        }
