...
namespace NCSDecomp.Core.Node
{
    public sealed class AConditionalJumpCommand : PConditionalJumpCommand
    {
        ...
        {
            return (object)new AConditionalJumpCommand(
             (PJumpIf)CloneNode(_jumpIf_),
        ...
        {
            return ToString(_jumpIf_) + ToString(_pos_) + ToString(_type_) + ToString(_offset_) + ToString(_semi_);
        }
