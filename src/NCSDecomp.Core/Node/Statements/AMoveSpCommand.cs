...
namespace NCSDecomp.Core.Node
{
    public sealed class AMoveSpCommand : PMoveSpCommand
    {
        ...
        {
            return (object)new AMoveSpCommand(
             (TMovsp)CloneNode(_movsp_),
        ...
        {
            ((IAnalysis)sw).CaseAMoveSpCommand(this);
        }
        ...
        {
            return ToString(_movsp_) + ToString(_pos_) + ToString(_type_) + ToString(_offset_) + ToString(_semi_);
        }
