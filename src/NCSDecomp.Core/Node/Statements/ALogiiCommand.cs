...
namespace NCSDecomp.Core.Node
{
    public sealed class ALogiiCommand : PLogiiCommand
    {
        ...
        {
            return (object)new ALogiiCommand(
             (PLogiiOp)CloneNode(_logiiOp_),
        ...
        {
            return ToString(_logiiOp_) + ToString(_pos_) + ToString(_type_) + ToString(_semi_);
        }
