...
namespace NCSDecomp.Core.Node
{
    public sealed class ACopyDownSpCommand : PCopyDownSpCommand
    {
        ...
        {
            return (object)new ACopyDownSpCommand(
             (TCpdownsp)CloneNode(_cpdownsp_),
