...
using GFFContent = Andastra.Formats.Formats.GFF.GFFContent;
...
using LIPAuto = Andastra.Formats.Formats.LIP.LIPAuto;

namespace Andastra.Formats.TSLPatcher
{
    // Matching PyKotor implementation at vendor/PyKotor/Libraries/PyKotor/src/pykotor/tslpatcher/diff/generator.py:68-129
    // Original: class TSLPatchDataGenerator: ...
            ...
            DirectoryInfo baseDataPath)
        {
            ...
            foreach (var modSsf in ssfModifications)
            {
                ...
                if (replaceFile)
                {
                    ...
                    {
                        if (modifier is Andastra.Formats.Mods.SSF.ModifySSF modifySsf)
                        {
                            try
                            {
