...
namespace Andastra.Formats
{
    ...
    public static class BinaryExtensions
    {
        ...
        public static Vector3 ReadVector3(this Andastra.Formats.BinaryReader reader)
        {
        ...
        public static void WriteVector3(this Andastra.Formats.BinaryWriter writer, Vector3 value)
        {
        ...
        public static Vector4 ReadVector4(this Andastra.Formats.BinaryReader reader)
        {
            float x = reader.ReadSingle();
            float y = reader.ReadSingle();
            float z = reader.ReadSingle();
        ...
        public static void WriteVector4(this Andastra.Formats.BinaryWriter writer, Vector4 value)
        {
            writer.WriteSingle(value.X);
            writer.WriteSingle(value.Y);
            writer.WriteSingle(value.Z);
        ...
        /// </summary>
        public static LocalizedString ReadLocalizedString(this Andastra.Formats.BinaryReader reader)
        {
        ...
        /// </summary>
        public static void WriteLocalizedString(this Andastra.Formats.BinaryWriter writer, LocalizedString value)
        {
            // Build the locstring data first to calculate total length
            using (var tempWriter = Andastra.Formats.BinaryWriter.ToByteArray())
            {
                // Write StringRef
