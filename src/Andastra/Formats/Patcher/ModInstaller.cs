...
using Andastra.Formats.Mods.NSS;
...
namespace Andastra.Formats.Patcher
{
    ...
    public class ModInstaller
    {
                ...
                if (!File.Exists(outputContainerPath))
                {
                    ...
                    if (IsModFile(outputContainerPath))
                    {
                        ...
                        log.AddNote(
                            ...
                            (Game != null && (Game.Value == Andastra.Formats.Game.TSL || Game.Value == Andastra.Formats.Game.K2) ? $"\n    Modules/{moduleRoot}_dlg.erf" : "")
                        );
                        try
                        {
        ...
        private void RimToMod(string modFilePath, string rimFolderPath, string moduleRoot)
        {
            ...
            if ((Game is null || Game.Value == Andastra.Formats.Game.TSL || Game.Value == Andastra.Formats.Game.K2) && File.Exists(filepathDlgErf))
            {
