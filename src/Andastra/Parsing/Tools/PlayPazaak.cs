...
namespace Andastra.Parsing.Tools
{
    ...
    public class PazaakSideCard
    {
        ...
        {
            if (CardType == Andastra.Parsing.Tools.CardType.YellowSpecial)
            {
                return $"Yellow {Value}";
            }
            string valueStr = Value.ToString();
            if (CardType == Andastra.Parsing.Tools.CardType.Positive)
            {
                return $"+{valueStr}";
            }
            if (CardType == Andastra.Parsing.Tools.CardType.Negative)
            {
                return $"-{valueStr}";
            }
            if (CardType == Andastra.Parsing.Tools.CardType.PosOrNeg)
            {
                return $"+/-{valueStr}";
            }
            return valueStr;
