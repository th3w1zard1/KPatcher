...
namespace Andastra.Formats.Tests.Common
{
    ...
    public class BinaryReaderTests
    {
        ...
        public void TestRead()
        {
            ...
            var reader1b = RawBinaryReader.FromBytes(_data1, offset: 3);
        ...
        public void TestSize()
        {
            ...
            var reader1c = RawBinaryReader.FromBytes(_data1, offset: 3, size: 4);
        ...
        public void TestPosition()
        {
            ...
            var reader1c = RawBinaryReader.FromBytes(_data1, offset: 3);
            reader1c.ReadBytes(1);
        ...
        public void TestRemaining()
        {
            ...
            var reader1c = RawBinaryReader.FromBytes(_data1, offset: 3, size: 12);
            reader1c.ReadUInt16();
    ...
    public class BinaryReaderPortedTests
    {
        ...
        public void TestSeekIgnoreAndTellInLittleEndianStream()
        {
            ...
            var reader = RawBinaryReader.FromBytes(inputData);
            int expectedPos = 7;
