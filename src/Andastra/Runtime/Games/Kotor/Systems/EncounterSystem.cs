...
namespace Andastra.Runtime.Kotor.Systems
{
    ...
    public class EncounterSystem
    {
        ...
        private readonly Func<Andastra.Formats.Module> _getCurrentModule;
        ...
        public EncounterSystem(IWorld world, FactionManager factionManager, Action<IEntity, ScriptEvent, IEntity> scriptExecutor, Loading.ModuleLoader moduleLoader, Func<IEntity, bool> isPlayerCheck = null, Func<Andastra.Formats.Module> getCurrentModule = null)
        ...
        private void SpawnEncounterCreatures(IEntity encounter, EncounterComponent encounterComp, int count)
        {
            ...
            for (int i = 0; i < count && spawned < encounterComp.MaxCreatures; i++)
            {
                ...
                {
                    Andastra.Formats.Module csharpModule = _getCurrentModule();
