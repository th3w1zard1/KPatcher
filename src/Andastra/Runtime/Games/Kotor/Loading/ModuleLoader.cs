...
namespace Andastra.Runtime.Kotor.Loading
{
    /// <summary>
    ...
    public class ModuleLoader
    {
        ...
        /// </summary>
        public Andastra.Formats.Module GetCurrentModule()
        {
        ...
        /// </summary>
        public Andastra.Formats.Resource.Generics.DLG.DLG LoadDialogue(string resRef)
        {
            if (_currentModule == null)
            {
                return null;
            ...
            return dlgData as Andastra.Formats.Resource.Generics.DLG.DLG;
        }
        ...
        public byte[] LoadScript(string resRef)
        {
            ...
            return Andastra.Formats.Resources.ResourceAuto.ReadResource(activePath, ResourceType.NCS);
        }
