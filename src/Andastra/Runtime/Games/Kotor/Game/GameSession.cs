...
using Andastra.Runtime.Kotor.Combat;
using Andastra.Runtime.Kotor.Systems;
using Andastra.Runtime.Kotor.Dialogue;
using Andastra.Runtime.Kotor.Loading;
using Andastra.Runtime.Kotor.EngineApi;
...
namespace Andastra.Runtime.Kotor.Game
{
    /// <summary>
    ...
    public class GameSession
    {
        ...
        public GameSession(GameSettings settings, World world, NcsVm vm, IScriptGlobals globals)
        {
            ...
            _engineApi = _settings.Game == KotorGame.K1
                ? (IEngineApi)new Andastra.Runtime.Games.Kotor.EngineApi.K1EngineApi()
                : (IEngineApi)new Andastra.Runtime.Games.Kotor.EngineApi.K2EngineApi();
            ...
            _encounterSystem = new Systems.EncounterSystem(
                ...
                () => _currentModule != null ? new Andastra.Formats.Module(_currentModuleName, _installation) : null
            );
        ...
        /// </summary>
        private Andastra.Formats.Resource.Generics.DLG.DLG LoadDialogue(string resRef)
        {
            ...
            try
            {
                Andastra.Formats.Installation.ResourceResult resource = _installation.Resources.LookupResource(resRef, ResourceType.DLG);
                if (resource == null || resource.Data == null)
                {
                    return null;
                }

                return Andastra.Formats.Resource.Generics.DLG.DLGHelper.ReadDlg(resource.Data);
            }
            catch (Exception ex)
            {
        ...
        private byte[] LoadScript(string resRef)
        {
            ...
            try
            {
                Andastra.Formats.Installation.ResourceResult resource = _installation.Resources.LookupResource(resRef, ResourceType.NCS);
                if (resource == null || resource.Data == null)
                {
                    return null;
                }
