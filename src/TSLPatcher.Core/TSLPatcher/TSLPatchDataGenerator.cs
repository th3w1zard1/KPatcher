...
using GFFContent = TSLPatcher.Core.Formats.GFF.GFFContent;
...
using LIPAuto = TSLPatcher.Core.Formats.LIP.LIPAuto;
            ...
            DirectoryInfo baseDataPath)
        {
            ...
            foreach (var modSsf in ssfModifications)
            {
                ...
                if (replaceFile)
                {
                    ...
                    {
                        if (modifier is global::TSLPatcher.Core.Mods.SSF.ModifySSF modifySsf)
                        {
