...
namespace TSLPatcher.Core.Tools
{
    ...
    public class PazaakSideCard
    {
        ...
        {
            if (CardType == global::TSLPatcher.Core.Tools.CardType.YellowSpecial)
            {
                return $"Yellow {Value}";
            }
            string valueStr = Value.ToString();
            if (CardType == global::TSLPatcher.Core.Tools.CardType.Positive)
            {
                return $"+{valueStr}";
            }
            if (CardType == global::TSLPatcher.Core.Tools.CardType.Negative)
            {
                return $"-{valueStr}";
            }
            if (CardType == global::TSLPatcher.Core.Tools.CardType.PosOrNeg)
            {
                return $"+/-{valueStr}";
            }
            return valueStr;
