...
using TSLPatcher.Core.Formats.NCS.NCSDecomp.Scriptutils;
using TSLPatcher.Core.Formats.NCS.NCSDecomp.Stack;
using IEnumerator = TSLPatcher.Core.Formats.NCS.NCSDecomp.IEnumerator<object>;
using IAnalysis = TSLPatcher.Core.Formats.NCS.NCSDecomp.Analysis.IAnalysis;

namespace TSLPatcher.Core.Formats.NCS.NCSDecomp.Utils
{
