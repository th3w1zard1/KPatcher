...
namespace TSLPatcher.Core.Formats.NCS.NCSDecomp.Lexer
{
    public class Lexer
    {
        ...
        public Lexer(PushbackReader @in)
        {
            ...
            if (Lexer.gotoTable == null)
            {
                try
                {
                    System.IO.Stream stream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("TSLPatcher.Core.Formats.NCS.NCSDecomp.lexer.dat") ?? System.Reflection.Assembly.GetCallingAssembly().GetManifestResourceStream("TSLPatcher.Core.Formats.NCS.NCSDecomp.lexer.dat");
                    if (stream == null)
                    {
