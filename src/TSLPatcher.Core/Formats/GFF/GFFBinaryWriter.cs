...
namespace TSLPatcher.Core.Formats.GFF
{
    ...
    public class GFFBinaryWriter
    {
        ...
        private readonly RawBinaryWriter _structWriter;
        private readonly RawBinaryWriter _fieldWriter;
        private readonly RawBinaryWriter _fieldDataWriter;
        private readonly RawBinaryWriter _fieldIndicesWriter;
        private readonly RawBinaryWriter _listIndicesWriter;
        ...
        {
            _gff = gff;
            _structWriter = RawBinaryWriter.ToByteArray();
            _fieldWriter = RawBinaryWriter.ToByteArray();
            _fieldDataWriter = RawBinaryWriter.ToByteArray();
            _fieldIndicesWriter = RawBinaryWriter.ToByteArray();
            _listIndicesWriter = RawBinaryWriter.ToByteArray();
        }
        ...
        public byte[] Write()
        {
            ...
            using (var fileWriter = RawBinaryWriter.ToByteArray())
            {
                // Write header
