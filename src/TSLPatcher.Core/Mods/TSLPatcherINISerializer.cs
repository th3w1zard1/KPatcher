...
using TargetType = TSLPatcher.Core.Mods.TwoDA.TargetType;
...
namespace TSLPatcher.Core.Mods
{
    ...
    public class TSLPatcherINISerializer
    {
        ...
        private string SerializeTokenUsage(object tokenUsage)
        {
            ...
            if (tokenUsage is global::TSLPatcher.Core.Memory.TokenUsageTLK tlkUsage)
            {
                return $"StrRef{tlkUsage.TokenId}";
            }
            if (tokenUsage is global::TSLPatcher.Core.Memory.TokenUsage2DA twodaUsage)
            {
                return $"2DAMEMORY{twodaUsage.TokenId}";
            }
            if (tokenUsage is global::TSLPatcher.Core.Memory.NoTokenUsage noToken)
            {
