...
namespace KPatcher.UI
{
    ...
    public class UpdateManager : IDisposable
    {
        ...
        /// </summary>
        public string AppcastUrl { get; set; } = "https://github.com/th3w1zard1/KPatcher.NET/releases/latest/download/appcast.xml";

        /// <summary>
        /// Gets or sets the appcast URL for beta/pre-release channel.
        /// </summary>
        public string BetaAppcastUrl { get; set; } = "https://github.com/th3w1zard1/KPatcher.NET/releases/download/bleeding-edge/appcast-beta.xml";
